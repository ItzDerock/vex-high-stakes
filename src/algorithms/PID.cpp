...
PIDController::PIDController(double kP, double kI, double kD)
    : _kP(kP), _kI(kI), _kD(kD), _Imax(0), debug(false) {}

PIDController::PIDController(double kP, double kI, double kD, double Imax)
    : _kP(kP), _kI(kI), _kD(kD), _Imax(Imax), debug(false) {}

PIDController::PIDController(double kP, double kI, double kD, double Imax,
                             bool debug)
    : _kP(kP), _kI(kI), _kD(kD), _Imax(Imax), debug(debug) {}
